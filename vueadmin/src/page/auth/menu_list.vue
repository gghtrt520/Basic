    ...
    <div class="container">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="240" align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.pid == 0 && scope.row.is_menu == 1" type="text" icon="el-icon-edit" @click="addSub(scope.$index, scope.row)">添加子菜单</el-button>
...
export default {
  ...
  methods: {
    ...
    // 获取 easy-mock 的模拟数据
    getData() {
      let params = { pid: this.form.pid, pid: this.form.pid, page: this.page, page_size: this.page_size };
      this.$post_('admin/auth-rule/auth_rule_list', params, (res) => {
        // console.log(res);
