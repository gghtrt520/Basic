<template>
  <div class="table">
    ...
    <el-dialog title="权限修改" :visible.sync="showAuth" width="60%">
      <el-tree ref="tree" :data="treeData" show-checkbox node-key="id" default-expand-all :default-checked-keys="checkedValue" :props="defaultProps">
      </el-tree>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$post_('admin/role/role_list', params, (res) => {
        console.log(res);
