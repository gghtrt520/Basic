<template>
  <div v-loading="ifload">
    <el-upload class="uploader" :action="serverUrl" name="file" :headers="header" :show-file-list="false" :http-request="uploadImg" :before-upload="beforeUpload">
    </el-upload>
    <quill-editor v-model="content" ref="myTextEditor" @change="onEditorChange($event)" :options="editorOption">
    </quill-editor>
